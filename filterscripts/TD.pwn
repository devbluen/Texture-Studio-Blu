	...
	*/
	...
	switch(dialogid)
	{
	    case 0: // Select project.
	    {
		    ...
		    ShowPlayerDialog(playerid, dialogid+1574, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Startup"), info, "Accept", "Cancelar");
		    return true;
	    }
	    ...
	    case 4: // Main edition menu (shows all the textdraws and lets you create a new one).
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid+1574, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, "Textdraw selection"), info, "Accept", "Cancelar");
	        return true;
	    }
	    ...
	    case 5:
	    {
	        ...
	        ShowPlayerDialog(playerid, dialogid+1574, DIALOG_STYLE_LIST, CreateDialogTitle(playerid, title), info, "Accept", "Cancelar");
	        return true;
	    }
	    ...
	    case 34:
	    {
	        ShowPlayerDialog(playerid, dialogid+1574, DIALOG_STYLE_INPUT, CreateDialogTitle(playerid, "Textdraw's Preview Model Index"), "Insert Model Index: (( ObjectID ))", "Accept", "Cancelar");
	        return true;
	    }
	    case 35:
	    {
