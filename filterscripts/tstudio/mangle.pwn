...
YCMD:prefabsets(playerid, arg[], help)
{
	if(help)
	{
		...
		SendClientMessage(playerid, STEALTH_GREEN, "Carregue um grupo pré-fabricado de objetos girados de acordo com a inclinação do solo.");
		return 1;
	}
...
YCMD:gsets(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Gire todos os objetos atualmente selecionados de acordo com a inclinação do solo.");
		return 1;
	}
...
YCMD:osets(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Gira o objeto atualmente selecionado de acordo com a inclinação do solo.");
		return 1;
	}
...
YCMD:cobjectsets(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Cria um objeto girado de acordo com a inclinação do mapa e o seleciona.");
		return 1;
	}
	...
	{
	    SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
        SendClientMessage(playerid, STEALTH_YELLOW, "Uso: /csobject <modelid>");
		return 1;
	}
	...
	if(CurrObject[playerid] != -1)
	{
		...
		if(modelarray > -1) format(line, sizeof(line), "Índice de objeto criado: %i Nome do modelo: %s", CurrObject[playerid], GetModelName(modelarray));
		else format(line, sizeof(line), "Índice de Objeto Criado: %i Nome do Modelo: Desconhecido", CurrObject[playerid]);
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
