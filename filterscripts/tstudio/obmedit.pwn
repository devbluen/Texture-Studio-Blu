...
static OBMEditor(playerid)
{
	...
	switch(OBMData[playerid][pOBMType])
	{
		case 1 .. 9:
		{
				...
				if(oresponse)
				{
					switch(olistitem)
					{
						...
						case 0:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMType, DIALOG_STYLE_LIST, "Texture Studio", line, "Ok", "Cancelar");
						}
						...
						case 1:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMModel, DIALOG_STYLE_INPUT, "Texture Studio", "Select a model", "Ok", "Cancelar");
						}
						...
						case 2:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMParts, DIALOG_STYLE_INPUT, "Texture Studio", "Number of parts", "Ok", "Cancelar");
						}
						...
						case 3:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMDegrees, DIALOG_STYLE_INPUT, "Texture Studio", "Degrees (Integer)", "Ok", "Cancelar");
						}
						...
						case 4:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMHS, DIALOG_STYLE_INPUT, "Texture Studio", "Horizontal Seperation or Seperation", "Ok", "Cancelar");
						}
						...
						case 5:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMVS, DIALOG_STYLE_INPUT, "Texture Studio", "Veritcal Seperation", "Ok", "Cancelar");
						}
						...
						case 7:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMOX, DIALOG_STYLE_INPUT, "Texture Studio", "Origin X", "Ok", "Cancelar");
						}
						...
						case 8:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMOY, DIALOG_STYLE_INPUT, "Texture Studio", "Origin Y", "Ok", "Cancelar");
						}
						...
						case 9:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMOZ, DIALOG_STYLE_INPUT, "Texture Studio", "Origin Z", "Ok", "Cancelar");
						}
						...
						case 10:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMORX, DIALOG_STYLE_INPUT, "Texture Studio", "Origin RX", "Ok", "Cancelar");
						...
						case 11:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMORY, DIALOG_STYLE_INPUT, "Texture Studio", "Origin RY", "Ok", "Cancelar");
						}
						...
						case 12:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMORZ, DIALOG_STYLE_INPUT, "Texture Studio", "Origin RZ", "Ok", "Cancelar");
						...
						case 13:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMORTRX, DIALOG_STYLE_INPUT, "Texture Studio", "Orientation RX", "Ok", "Cancelar");
						}
						...
						case 14:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMORTRY, DIALOG_STYLE_INPUT, "Texture Studio", "Orientation RY", "Ok", "Cancelar");
						}
						...
						case 15:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMORTRZ, DIALOG_STYLE_INPUT, "Texture Studio", "Orientation RZ", "Ok", "Cancelar");
						}
						...
						case 16:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMRadius, DIALOG_STYLE_INPUT, "Texture Studio", "Radius", "Ok", "Cancelar");
						}
						...
						case 20:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMReset, DIALOG_STYLE_MSGBOX, "Texture Studio", "Reset all values?", "Ok", "Cancelar");
						}
						...
						case 21:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMHideStack, DIALOG_STYLE_MSGBOX, "Texture Studio", "Hide objectmetry?", "Ok", "Cancelar");
						}
					}
				}
				else
			...
			Dialog_ShowCallback(playerid, using inline OBMEdit, DIALOG_STYLE_LIST, "Texture Studio", line, "Ok", "Cancelar");
		}
		case 10 .. 100: {
			inline OBMEdit(opid, odialogid, oresponse, olistitem, string:otext[])
			{
				...
				if(oresponse)
				{
					switch(olistitem)
					{
						...
						case 7 :
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMOX, DIALOG_STYLE_INPUT, "Texture Studio", "End X", "Ok", "Cancelar");
						}
						...
						case 8 :
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMOY, DIALOG_STYLE_INPUT, "Texture Studio", "End Y", "Ok", "Cancelar");
						}
						...
						case 9 :
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMOZ, DIALOG_STYLE_INPUT, "Texture Studio", "End Z", "Ok", "Cancelar");
						}
						...
						case 16:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMHS, DIALOG_STYLE_INPUT, "Texture Studio", "Dimension", "Ok", "Cancelar");
						}
						...
						case 19:
						{
							...
							Dialog_ShowCallback(playerid, using inline OBMHS, DIALOG_STYLE_INPUT, "Texture Studio", "Dimension Segments", "Ok", "Cancelar");
						}
