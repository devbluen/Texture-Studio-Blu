...
ShowObjectPropMenu(playerid)
{
		...
		if(sresponse)
		{
		    switch(slistitem)
		    {
		        ...
		        case 0:
		        {
					...
					Dialog_ShowCallback(playerid, using inline ChangeGroup, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new group", "Ok", "Cancelar");
				}
				...
				case 1:
				{
				    ...
				    Dialog_ShowCallback(playerid, using inline ChangeModel, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new model", "Ok", "Cancelar");
				}
				...
				case 2..7:
				{
				    ...
				    Dialog_ShowCallback(playerid, using inline ChangePosition, DIALOG_STYLE_INPUT, "Texture Studio", line, "Ok", "Cancelar");
				}
				...
				case 8..23:
				{
                    ...
                    Dialog_ShowCallback(playerid, using inline ChangeMaterial, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new material index", "Ok", "Cancelar");
				}
				...
				case 24..39:
				{
                    ...
                    Dialog_ShowCallback(playerid, using inline ChangeColor, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new color use 0xFFFFFFFF format input", "Ok", "Cancelar");
				}
				...
				case 41:
				{
                    ...
                    Dialog_ShowCallback(playerid, using inline PropFontFace, DIALOG_STYLE_LIST, "Texture Studio", line, "Ok", "Cancelar");
				}
				...
				case 42:
				{
                    ...
                    Dialog_ShowCallback(playerid, using inline PropFontSize, DIALOG_STYLE_LIST, "Texture Studio", line, "Ok", "Cancelar");
				}
				...
				case 44:
				{
                    ...
                    Dialog_ShowCallback(playerid, using inline ChangeFontColor, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new color use 0xFFFFFFFF format input", "Ok", "Cancelar");
				}
				...
				case 45:
				{
                    ...
                    Dialog_ShowCallback(playerid, using inline ChangeFontBackColor, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new color use 0xFFFFFFFF format input", "Ok", "Cancelar");
				}
				...
				case 47:
				{
                    ...
                    Dialog_ShowCallback(playerid, using inline ChangeTextSize, DIALOG_STYLE_INPUT, "Texture Studio", "A new text size", "Ok", "Cancelar");
				...
				case 48:
				{
                    ...
                    Dialog_ShowCallback(playerid, using inline ChangeTextString, DIALOG_STYLE_INPUT, "Texture Studio", "A new text string", "Ok", "Cancelar");
				}
				...
				case 49:
				{
				    ...
				    Dialog_ShowCallback(playerid, using inline ChangeNote, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new note", "Ok", "Cancelar");
				}
				...
				case 50:
				{
				    ...
				    Dialog_ShowCallback(playerid, using inline ChangeDD, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new draw distance", "Ok", "Cancelar");
				}
		    }
		}
	}
	...
	Dialog_ShowCallback(playerid, using inline SelectObjProp, DIALOG_STYLE_LIST, "Texture Studio - Object Property editor", propline, "Ok", "Cancelar");
...
ShowMapPropMenu(playerid)
{
		...
		if(sresponse)
		{
		    switch(slistitem)
		    {
		        ...
		        case 0:
		        {
					...
					Dialog_ShowCallback(playerid, using inline ChangeInterior, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new interior", "Ok", "Cancelar");
				}
				...
				case 1:
				{
				    ...
				    Dialog_ShowCallback(playerid, using inline ChangeVW, DIALOG_STYLE_INPUT, "Texture Studio", "Enter new virtual world", "Ok", "Cancelar");
				}
		    }
		}
	}
	...
	Dialog_ShowCallback(playerid, using inline SelectMapProp, DIALOG_STYLE_LIST, "Texture Studio - Map Property editor", propline, "Ok", "Cancelar");
