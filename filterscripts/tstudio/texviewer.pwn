...
YCMD:tsearch(playerid, arg[], help)
{
	if(help)
	{
		...
		SendClientMessage(playerid, STEALTH_GREEN, "Pesquise índices de textura por palavra-chave.");
		return 1;
	}

	SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
	if(isnull(arg)) return SendClientMessage(playerid, STEALTH_YELLOW, "Você deve fornecer uma string de pesquisa de textura");
	...
	inline TexSearch(pid, dialogid, response, listitem, string:text[])
	{
		...
		if(response)
		{
			if(!strcmp(text, "Próxima página ->"))
				page++;
			else if(!strcmp(text, "Página anterior <-"))
				page--;
			...
			if(page != lastpage)
			{
				...
				if(page)
					strcat(sFoundTextures, "{00CC00}Página anterior <-{FFFFFF}\n");
				...
				for(new i, j; i < sizeof(ObjectTextures); i++)
				{
					if(Bit_Get(FoundTextures, i))
					{
						if((page * 100) < j < ((page + 1) * 100) + 1)
						{
							...
							if(j == ((page + 1) * 100))
							{
								strcat(sFoundTextures, "{00CC00}Próxima página ->");
								break;
							}
						}
						j++;
				...
				lastpage = page;
				Dialog_ShowCallback(playerid, using inline TexSearch, DIALOG_STYLE_LIST, "Texture Studio - Pesquisa de textura", sFoundTextures, "Ok", "Cancelar");
			}
			else
			{
				new index;
	...
	if(numfound)
	{
		format(line, sizeof(line), "Foram encontradas %i texturas", numfound);
		...
		for(new i, j; i < sizeof(ObjectTextures); i++)
		{
			if(Bit_Get(FoundTextures, i))
			{
				...
				if(j == 100)
				{
					strcat(sFoundTextures, "Próxima página ->");
					break;
				}
			}
		}
	...
	else SendClientMessage(playerid, STEALTH_YELLOW, "Nenhuma textura encontrada com essa string");
	return 1;
}
...
YCMD:mtextures(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Abra o visualizador de textura 3D.");
		SendClientMessage(playerid, STEALTH_YELLOW, "Controles a pé:");
		SendClientMessage(playerid, STEALTH_GREEN, "    Y - Última Textura, H - Próxima Textura");
		SendClientMessage(playerid, STEALTH_GREEN, "    Num 4 - Última página, Num 6 - Próxima página");
		SendClientMessage(playerid, STEALTH_YELLOW, "Controls in flymode:");
		SendClientMessage(playerid, STEALTH_GREEN, "    Enter + Num 4 - Última Textura, Enter + Num 6 - Próxima Textura");
		SendClientMessage(playerid, STEALTH_GREEN, "    Num 4 - Última página, Num 6 - Próxima página");
		return 1;
	}
	...
	if(Menu3DData[playerid][TPreviewState] == PREVIEW_STATE_NONE)
	{
		...
		UpdateTextureInfo(playerid, SelectedBox[playerid]);
   		...
   		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Ferramenta de seleção de textura aberta – Todas as texturas");
		SendClientMessage(playerid, STEALTH_GREEN, "Veja /thelp para controles de seleção de textura");
	...
	else if(Menu3DData[playerid][TPreviewState] == PREVIEW_STATE_ALLTEXTURES)
	{
		...
		else
		{
			...
			UpdateTextureInfo(playerid, SelectedBox[playerid]);
	   		...
	   		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
			SendClientMessage(playerid, STEALTH_GREEN, "Slot de seleção de textura alterado – Todas as texturas");
		}
	}
	else if(Menu3DData[playerid][TPreviewState] !=  PREVIEW_STATE_ALLTEXTURES)
	{
		...
		UpdateTextureInfo(playerid, SelectedBox[playerid]);
   		...
   		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Mudou para visualizar todas as texturas");
	}
...
YCMD:ttextures(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Visualize um conjunto salvo de texturas no visualizador de textura 3D.");
		SendClientMessage(playerid, STEALTH_YELLOW, "Controles a pé:");
		SendClientMessage(playerid, STEALTH_GREEN, "    Y - Última Textura, H - Próxima Textura");
		SendClientMessage(playerid, STEALTH_GREEN, "    Num 4 - Última página, Num 6 - Próxima página");
		SendClientMessage(playerid, STEALTH_YELLOW, "Controls in flymode:");
	...
	if(Menu3DData[playerid][TPreviewState] == PREVIEW_STATE_NONE)
	{
		...
		UpdateTextureInfo(playerid, SelectedBox[playerid]);
   		...
   		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Ferramenta de seleção de textura aberta - Texturas de tema");
		SendClientMessage(playerid, STEALTH_GREEN, "Veja /thelp para controles de seleção de textura");
	}
	...
	else if(Menu3DData[playerid][TPreviewState] != PREVIEW_STATE_THEME)
	{
        ...
        UpdateThemeTextures(playerid);
   		...
   		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Mudou para visualizar texturas de tema");
	}
...
YCMD:mtsearch(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "O mesmo que /tsearch, mas no visualizador de textura 3D.");
		SendClientMessage(playerid, STEALTH_YELLOW, "Controles a pé:");
		SendClientMessage(playerid, STEALTH_GREEN, "    Y - Última Textura, H - Próxima Textura");
		SendClientMessage(playerid, STEALTH_GREEN, "    Num 4 - Última página, Num 6 - Próxima página");
		SendClientMessage(playerid, STEALTH_YELLOW, "Controls in flymode:");
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, sprintf("Foram encontradas %i texturas", PlayerSearchResults[playerid]));
		...
		if(Menu3DData[playerid][TPreviewState] == PREVIEW_STATE_NONE)
		{
			...
			SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
			SendClientMessage(playerid, STEALTH_GREEN, "Ferramenta de seleção de textura aberta – Resultados da pesquisa");
			SendClientMessage(playerid, STEALTH_GREEN, "Veja /thelp para controles de seleção de textura");
		}
		else if(Menu3DData[playerid][TPreviewState] == PREVIEW_STATE_SEARCH)
		{
			...
			SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
			SendClientMessage(playerid, STEALTH_GREEN, "Resultados da pesquisa de textura atualizados - Resultados da pesquisa");
		}
		else if(Menu3DData[playerid][TPreviewState] != PREVIEW_STATE_SEARCH)
		{
			Menu3DData[playerid][CurrTexturePage] = 0;
			...
			SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
			SendClientMessage(playerid, STEALTH_GREEN, "Mudou para visualizar resultados de pesquisa/mtsearch");
		}
	}
	else 
	{
		...
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_YELLOW, "Nenhuma textura encontrada com essa string");
	}
	return 1;
}
...
OnPlayerKeyStateChangeMenu(playerid,newkeys,oldkeys)
{
	...
	else if(newkeys & KEY_SPRINT && (FlyMode[playerid] || newkeys & KEY_HANDBRAKE))
	{
	    ...
	    if(Menu3DData[playerid][TPreviewState] != PREVIEW_STATE_THEME)
	    {
			...
			{
		   		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
				SendClientMessage(playerid, STEALTH_GREEN, "Textura adicionada à seleção do tema");
			}
			else if(addt == -1)
			{
		   		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
				SendClientMessage(playerid, STEALTH_GREEN, "Esta textura já foi adicionada");
			}
			else if(addt == -2)
			{
		   		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
				SendClientMessage(playerid, STEALTH_GREEN, "Tentei adicionar muitas texturas ao seu tema");
			}
			return 1;
		}
	}
...
static UpdateTextureInfo(playerid, boxid)
{
	...
	if(Menu3DData[playerid][TPreviewState] == PREVIEW_STATE_ALLTEXTURES)
	{
		...
		{
			format(line, sizeof(line), "~n~~n~Modelo: %i TXD: %s Textura: %s~n~~r~Índice: %i/%i", ObjectTextures[boxid + 16 * Menu3DData[playerid][CurrTexturePage]][TModel],
		...
		{
			format(line, sizeof(line), "~n~~n~Modelo: %i TXD: %s Textura: %s~n~~r~Índice: %i/%i", ObjectTextures[0][TModel],
	...
	else if(Menu3DData[playerid][TPreviewState] == PREVIEW_STATE_THEME)
	{
		...
		{
			format(line, sizeof(line), "~n~~n~Modelo: %i TXD: %s Textura: %s~n~~r~Índice: %i/%i~n~Índice de Tema: %i/%i",
	...
	else if(Menu3DData[playerid][TPreviewState] == PREVIEW_STATE_SEARCH)
	{
		...
		{
			format(line, sizeof(line), "~n~~n~Modelo: %i TXD: %s Textura: %s~n~~r~Índice: %i/%i~n~Índice de pesquisa: %i/%i",
...
YCMD:savetheme(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Salve algumas texturas como tema para usar posteriormente.");
		return 1;
	}
	...
	{
  		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_YELLOW, "Você não tem texturas para salvar no tema!");
	}
	else
	{
	    inline SaveTheme(tpid, tdialogid, tresponse, tlistitem, string:ttext[])
		{
			...
			if(tresponse)
			{
				...
				{
			  		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
					SendClientMessage(playerid, STEALTH_YELLOW, "Você deve fornecer um nome de tema para salvar!");
				}
						    ...
						    inline ReplaceTheme(rpid, rdialogid, rresponse, rlistitem, string:rtext[])
							{
							    ...
							    if(rresponse)
								{
									SavePlayerTheme(playerid, ttext,true);
							  		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
									SendClientMessage(playerid, STEALTH_GREEN, "O tema foi salvo!");
								}
						    }
						    Dialog_ShowCallback(playerid, using inline ReplaceTheme, DIALOG_STYLE_MSGBOX, "Texture Studio", "Existe um tema com este nome que você pode substituir?", "Ok", "Cancelar");
							return 1;
						}
						db_next_row(r);
				    }
		...
		Dialog_ShowCallback(playerid, using inline SaveTheme, DIALOG_STYLE_INPUT, "Texture Studio", "Escolha um nome de tema para salvar", "Ok", "Cancelar");
...
YCMD:deletetheme(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Exclua um tema de textura salvo.");
		return 1;
	}
			    ...
			    inline ClearTheme(cpid, cdialogid, cresponse, clistitem, string:ctext[])
			    {
					...
					if(cresponse)
					{
						if(strcmp("default_theme", ltext))
						{
							...
							SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
							SendClientMessage(playerid, STEALTH_GREEN, "Tema excluído!");
						}
						else
						{
							SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
							SendClientMessage(playerid, STEALTH_YELLOW, "Você não pode excluir o tema padrão!");
						}
					}
			    }
                Dialog_ShowCallback(playerid, using inline ClearTheme, DIALOG_STYLE_MSGBOX, "Texture Studio", "Excluir tema?", "Ok", "Cancelar");
			}
		}
        Dialog_ShowCallback(playerid, using inline DeleteTheme, DIALOG_STYLE_LIST, "Excluir um tema", line, "Ok", "Cancelar");
	}
	else
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_YELLOW, "Não há temas para excluir!");
	}
...
YCMD:loadtheme(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Carregue um tema de textura salvo.");
		return 1;
	}
			...
			if(lresponse)
			{
			    inline ClearTheme(cpid, cdialogid, cresponse, clistitem, string:ctext[])
			    {
			        ...
			        if(cresponse) LoadPlayerTheme(playerid, ltext, true);
			  		...
			  		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
					SendClientMessage(playerid, STEALTH_GREEN, "O tema foi carregado!");
			    }
                Dialog_ShowCallback(playerid, using inline ClearTheme, DIALOG_STYLE_MSGBOX, "Texture Studio", "Limpar tema existente?", "Ok", "Cancelar");
			}
		}
        Dialog_ShowCallback(playerid, using inline LoadTheme, DIALOG_STYLE_LIST, "Texture Studio - Carregar um tema", line, "Ok", "Cancelar");
	}
	else
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_YELLOW, "Não há temas para carregar!");
	}
...
YCMD:settindex(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Defina o índice de texturização atualmente selecionado.");
		return 1;
	}
	...
	new index = strval(arg);
	if(index < 0 || index > 15) return SendClientMessage(playerid, STEALTH_YELLOW, "Uso: /settindex <índice> (0-15)");

	CurrTexturingIndex[playerid] = index;
	new line[128];
	format(line, sizeof(line), "Índice de texturização atual definido como %i", index);
	SendClientMessage(playerid, STEALTH_GREEN, line);
...
YCMD:stexture(playerid, arg[], help)
{
	...
	{
		SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
		SendClientMessage(playerid, STEALTH_GREEN, "Editor de textura.");
		return 1;
	}
...
ClickTextDrawEditMat(playerid, Text:clickedid)
{
	for(new i = 0; i < MAX_MATERIALS; i++)
	{
	    ...
	    else if(Click_SetColor[i] == clickedid)
	    {
				...
				if(sresponse)
				{
				    ...
				    switch(slistitem)
				    {
				        case 0:
						{
                            ...
                            Dialog_ShowCallback(playerid, using inline SelectHexColor, DIALOG_STYLE_INPUT, "Texture Studio - Hexadecimal", "Cor hexadecimal (0x00000000) ARGB", "Ok", "Cancelar");
						}
				        case 1:
						{
                            ...
                            inline SelectRed(redpid, reddialogid, redresponse, redlistitem, string:redtext[])
                            {
								...
								{
									red = strval(redtext);
									if(red < 0 || red > 255) Dialog_ShowCallback(playerid, using inline SelectRed, DIALOG_STYLE_INPUT, "Estúdio de Textura - Combinador de Cores", "Insira o valor vermelho <0 - 255>", "Ok", "Cancelar");
									else
									{
									    inline SelectGreen(greenpid, greendialogid, greenresponse, greenlistitem, string:greentext[])
									    {
											...
											if(greenresponse)
											{
												...
												if(green < 0 || green > 255) Dialog_ShowCallback(playerid, using inline SelectGreen, DIALOG_STYLE_INPUT, "Estúdio de Textura - Combinador de Cores", "Insira o valor verde <0 - 255>", "Ok", "Cancelar");
												else
												{
												    inline SelectBlue(bluepid, bluedialogid, blueresponse, bluelistitem, string:bluetext[])
												    {
														...
														if(blueresponse)
														{
															...
															if(blue < 0 || blue > 255) Dialog_ShowCallback(playerid, using inline SelectBlue, DIALOG_STYLE_INPUT, "Estúdio de Textura - Combinador de Cores", "Insira o valor azul <0 - 255>", "Ok", "Cancelar");
															else
															{
															    inline SelectAlpha(alphapid, alphadialogid, alpharesponse, alphalistitem, string:alphatext[])
															    {
																	...
																	if(alpharesponse)
																	{
																		...
																		if(alpha < 0 || alpha > 255) Dialog_ShowCallback(playerid, using inline SelectAlpha, DIALOG_STYLE_INPUT, "Estúdio de Textura - Combinador de Cores", "Insira o valor alfa <0 - 255>\nObservação: deixar em branco significa alfa 255 completo", "Ok", "Cancelar");
																		else
																		{
																		   	SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
																...
																Dialog_ShowCallback(playerid, using inline SelectAlpha, DIALOG_STYLE_INPUT, "Estúdio de Textura - Combinador de Cores", "Insira o valor alfa <0 - 255>\nObservação: deixar em branco significa alfa 255 completo", "Ok", "Cancelar");
															}
														}
													}
													Dialog_ShowCallback(playerid, using inline SelectBlue, DIALOG_STYLE_INPUT, "Estúdio de Textura - Combinador de Cores", "Insira o valor azul <0 - 255>", "Ok", "Cancelar");
												}
											}
									    }
									    Dialog_ShowCallback(playerid, using inline SelectGreen, DIALOG_STYLE_INPUT, "Estúdio de Textura - Combinador de Cores", "Insira o valor verde <0 - 255>", "Ok", "Cancelar");
									}
								}
                            }
                            Dialog_ShowCallback(playerid, using inline SelectRed, DIALOG_STYLE_INPUT, "Estúdio de Textura - Combinador de Cores", "Insira o valor vermelho <0 - 255>", "Ok", "Cancelar");
						}
				        case 2:
						{
                            ...
                            Dialog_ShowCallback(playerid, using inline SelectWebColor, DIALOG_STYLE_LIST, "Texture Studio - Selecione a cor da Web", webcolors, "Ok", "Cancelar");
						}
						case 3:
						{
                            if(TextureAll[playerid])
			...
			Dialog_ShowCallback(playerid, using inline SelectColorMet, DIALOG_STYLE_LIST, "Texture Studio - Selecione o método de cor", "Valor hexadecimal\nCombinador\nCores da Web\nRedefinir cor", "Ok", "Cancelar");
			return 1;
	    }
	    ...
	    else if(Click_ClearTexture[i] == clickedid)
	    {
			if(TextureAll[playerid])
			{
				...
				format(line, sizeof(line), "/mtcolorall %i 0x00000000", i);
				BroadcastCommand(playerid, line);
				format(line, sizeof(line), "Textura e cor apagadas no slot %i para todos os objetos", i);
				SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
				SendClientMessage(playerid, STEALTH_GREEN, line);
			}
			else
			{
				...
				format(line, sizeof(line), "/mtcolor %i 0x00000000", i);
				BroadcastCommand(playerid, line);
				format(line, sizeof(line), "Textura e cor apagadas no slot %i", i);
				SendClientMessage(playerid, STEALTH_ORANGE, "______________________________________________");
				SendClientMessage(playerid, STEALTH_GREEN, line);
			}
			return 1;
...
ClickPlayerTextDrawEditMat(playerid, PlayerText:playertextid)
{
	if(Click_TextureAll[playerid] == playertextid)
	{
		...
		if(TextureAll[playerid])
		{
		    ...
		    PlayerTextDrawColor(playerid, Click_TextureAll[playerid], 0xFF0000FF);
		    PlayerTextDrawShow(playerid, Click_TextureAll[playerid]);
		    SendClientMessage(playerid, STEALTH_GREEN, "Somente o objeto que você está editando no momento será texturizado");
		}
		else
		{
		    ...
		    PlayerTextDrawShow(playerid, Click_TextureAll[playerid]);
		    SendClientMessage(playerid, STEALTH_GREEN, "Todos os objetos semelhantes agora serão texturizados");
		}
		return 1;
    }
	return 0;
